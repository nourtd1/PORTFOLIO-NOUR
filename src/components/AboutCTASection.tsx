  ...
  const features = [
    {
      ...
      description: "Accédez à mon CV complet au format PDF"
    },
    {
      icon: Mail,
      title: "Contact Direct",
      description: "Échangez directement sur vos projets"
    },
    {
      icon: Calendar,
      title: "Disponibilité",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <span className="text-white font-medium">Intéressé par mon profil ?</span>
          </motion.div>
          ...
          >
            ...
            et découvrir comment nous pouvons créer quelque chose d'extraordinaire ensemble.
          </motion.p>
        </motion.div>
