    ...
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            Vous cherchez un développeur passionné pour donner vie à votre projet ? 
            Je combine expertise technique et créativité pour créer des solutions 
            qui marquent les esprits et génèrent des résultats.
          </motion.p>
        </motion.div>
